...
<div class="row">
	<div class="col-12">
        ...
        <form method="POST" action="{{ route('innovator.store') }}" enctype="multipart/form-data" class="row">
            ...
            <div class="form-group col-lg-6">
                ...
                <input type="text" class="form-control" name="iname" placeholder="Enter Name" value="{{ old('iname') }}">
            ...
            <div class="form-group col-lg-12">
                ...
                <span style="color: #FC1838">{{$errors->first('about')}}</span>
			</div>

			<div class="form-group col-lg-12">
				<label for="accomplishments">Accomplishments</label>
				<textarea name="accomplishments" class="form-control" id="accomplishements">{{ old('accomplishments') }}</textarea>
                <span style="color: #FC1838">{{$errors->first('accomplishments')}}</span>
			</div>
            <div class="col-lg-4">
