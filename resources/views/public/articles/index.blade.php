...
<div class="container-fluid">
    <div class="row justify-content-center align-items-center" id="banner">
        <div class="col-lg-6 text-center">
            <h1 class=" mt-5 h-b display-3 text-light" >Latest Articles</h1>
       </div>
    </div>
</div>
      ...
      <div class="row justify-content-center ">
          <div class="col-lg-10">
            ...
            <div class="row border border-2 rounded py-3 m-lg-0 mt-lg-3 m-3">
                ...
                <div class="col-lg-7" >
                    <div class="row  pt-3 pt-lg-0">
                        ...
                        <small class="date-sm">  {{ $a->date != null ?  \Carbon\Carbon::parse($a->date)->format('F j, Y') : $a->created_at->format('F j, Y') }} &nbsp; Article</small> <br>
                        <small class="date-sm">{{ $a->tag }}</small>
                        <p class="">{!! mb_strimwidth(strip_tags($a->description), 0, 350, '...') !!}</p>
            ...
            <div class="d-flex flex-row mt-5">
                <nav class="mx-auto">{{ $articles->links() }}</nav>
            </div>
          </div>
      </div>
    </div>
