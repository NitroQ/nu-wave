...
<div class="container-fluid">
    <div class="row justify-content-center align-items-center" id="banner">
        <div class="col-lg-6 text-center">
            <h1 class=" mt-5 h-b display-3 text-light">Latest Products</h1>
       </div>
    </div>
</div>
          ...
          <div class="col-lg-10">
            ...
            <div class="row border border-2 rounded py-3 mt-3">
                <div class="col-lg-5 d-flex justify-content-center" >
                    <img src="/uploads/products/{{ $a->image or 'placeholder.png' }}" alt="" id="article-img" class="img-fluid">
                </div>
                <div class="col-lg-7" >
                    <div class="row  pt-3 pt-lg-0">
                        ...
                        <p class="">{!! mb_strimwidth(strip_tags($a->abstract), 0, 350, '...') !!}</p>
                        
                    </div>
                    <div class="row text-end" >
                        <div class="pe-3">
                            <a href="{{ route('products-view' , [$a->id]) }}" class="text-decoration-none color-blue fw-bolder">Read Details <i class="fas fa-chevron-circle-right ms-1"></i></a>
                        </div>
                    </div>
            ...
            <div class="d-flex flex-row mt-5">
                <nav class="mx-auto">{{ $products->links() }}</nav>
            </div>
          </div>
